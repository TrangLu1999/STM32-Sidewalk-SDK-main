...
#ifndef SID_RADIO_PLATFORM_SX126X
...
#define SX126X_SIDEWALK_FSK_CS_DURATION_US          (1200u)   /*!< Carrier Sense timeout for FSK link as defined by Sidewalk specification (1200us) */
#define SX126X_SIDEWALK_FSK_CS_RSSI_THRESHOLD       (-80)     /*!< Carrier Sense RSSI threshold in dBm - any signal above that level means the radio channel is busy */
