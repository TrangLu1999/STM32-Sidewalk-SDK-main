/**
  ******************************************************************************
  * @file    lr11xx_radio_ext_ifc.h
  * @brief   Extended API for the LR11xx Sidewalk radio driver
  ******************************************************************************
  * @attention
  *
...
#ifndef __SID_LR11XX_RADIO_EXT_IFC_H_
#define __SID_LR11XX_RADIO_EXT_IFC_H_
 ...
 *
 * @attention It is highly recommended to stop sub-GHz Sidewalk links via sid_stop() before enabling LBM operations
 *
 ...
 */
int32_t sid_pal_radio_lr11xx_start_lbm_bridge_mode(const radio_lr11xx_lbm_bridge_state_t desired_mode);
 ...
 * @returns Non-zero value in case of error
 */
int32_t sid_pal_radio_lr11xx_stop_lbm_bridge_mode(void);

/**
 * @brief Report current operating mode of LoRa Basics Modem (LBM) bridge in Sidewalk radio driver
 *
 * @returns Current LBM bridge operating mode. See @ref radio_lr11xx_lbm_bridge_state_t
 */
radio_lr11xx_lbm_bridge_state_t sid_pal_radio_lr11xx_get_lbm_bridge_mode(void);
...
#endif /* __SID_LR11XX_RADIO_EXT_IFC_H_ */
