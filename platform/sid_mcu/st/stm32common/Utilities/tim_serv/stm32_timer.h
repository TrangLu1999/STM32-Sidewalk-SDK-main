...
/**
  ...
  * @retval Status based on @ref UTIL_TIMER_Status_t
  */
UTIL_TIMER_Status_t UTIL_TIMER_Create(UTIL_TIMER_Object_t * const TimerObject, const uint32_t PeriodValue, const UTIL_TIMER_Mode_t Mode, void ( * const Callback )( void *) , void * const Argument);
...
/**
  ...
  * @retval Status based on @ref UTIL_TIMER_Status_t
  */
UTIL_TIMER_Status_t UTIL_TIMER_Start(UTIL_TIMER_Object_t * const TimerObject );
...
/**
  ...
  * @retval Status based on @ref UTIL_TIMER_Status_t
  */
UTIL_TIMER_Status_t UTIL_TIMER_StartWithPeriod(UTIL_TIMER_Object_t * const TimerObject, const uint32_t PeriodValue);
...
/**
  ...
  * @retval Status based on @ref UTIL_TIMER_Status_t
  */
UTIL_TIMER_Status_t UTIL_TIMER_Stop(UTIL_TIMER_Object_t * const TimerObject);
...
/**
  ...
  * @retval Status based on @ref UTIL_TIMER_Status_t
  */
UTIL_TIMER_Status_t UTIL_TIMER_SetPeriod(UTIL_TIMER_Object_t * const TimerObject, const uint32_t NewPeriodValue);
 ...
 * @retval Status based on @ref UTIL_TIMER_Status_t
 */
UTIL_TIMER_Status_t UTIL_TIMER_SetReloadMode(UTIL_TIMER_Object_t * const TimerObject, const UTIL_TIMER_Mode_t ReloadMode);
 ...
 */
uint32_t UTIL_TIMER_IsRunning(const UTIL_TIMER_Object_t * const TimerObject);
...
/**
  ...
  */
UTIL_TIMER_Time_t UTIL_TIMER_GetElapsedTime(const UTIL_TIMER_Time_t past);
...
/**
  ...
  */
const UTIL_TIMER_Object_t * UTIL_TIMER_GetTimerList(void);
