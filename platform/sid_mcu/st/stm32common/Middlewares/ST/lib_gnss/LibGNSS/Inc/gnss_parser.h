...
#define NMEA_MSGS_NUM 23 //Note: update this constant coherently to eMsg enum type
...
/*vvv PATCH STMC-474 vvvvvvvvvv*/
  GLL_Info_t   gll_data;   /**< $--GLL Data holder */
  VTG_Info_t   vtg_data;   /**< $--VTG Data holder */
  GPTXT_Info_t gptxt_data; /**< $GPTXT Data holder */
  PSTMCPU_Info_t pstmcpu_data; /**< $PSTMCPU Data holder */
  PSTMSETPAR_Info_t pstmsetpar_data; /**< $PSTMSETPAR Data holder */
/*^^^ END OF PATCH STMC-474 ^^^*/
