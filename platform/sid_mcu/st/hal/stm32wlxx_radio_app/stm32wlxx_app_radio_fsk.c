/**
  ******************************************************************************
  * @file  stm32wlxx_app_radio_fsk.c
...
#define RADIO_FSK_BR_50KBPS                     (50000u)
#define RADIO_FSK_BR_150KBPS                    (150000u)
#define RADIO_FSK_BR_250KBPS                    (250000u)

#define RADIO_FSK_FDEV_19KHZ                    (19000u)
#define RADIO_FSK_FDEV_25KHZ                    (25000u)
#define RADIO_FSK_FDEV_37_5KHZ                  (37500u)
#define RADIO_FSK_FDEV_62_5KHZ                  (62500u)
...
const sid_pal_radio_fsk_phy_settings_t fsk_phy_default_cfg = {
    .sync_word                     = {0x55u, 0x6Fu, 0x4Eu},
    .sync_word_len                 = WL55_FSK_SYNC_WORD_LENGTH_IN_RX,
    .whitening_seed                = SID_PAL_RADIO_FSK_WHITENING_SEED,
    .fsk_modulation_params = {
        .bit_rate                  = RADIO_FSK_BR_50KBPS,
        .freq_dev                  = RADIO_FSK_FDEV_25KHZ,
        .mod_shaping               = SID_PAL_RADIO_FSK_MOD_SHAPING_G_BT_1,
        .bandwidth                 = SID_PAL_RADIO_FSK_BW_150KHZ,
    },
    .fsk_cad_params = {
        .fsk_cs_min_prm_det        = SID_PAL_RADIO_FSK_PREAMBLE_DETECTOR_16_BITS,
        .fsk_cs_duration_us        = STM32WLxx_SIDEWALK_FSK_CS_DURATION_US,
    },
};
...
SID_STM32_SPEED_OPTIMIZED int32_t sid_pal_radio_prepare_fsk_for_tx(sid_pal_radio_fsk_pkt_cfg_t * tx_pkt_cfg)
{
    ...
    do
    {
        ...
        {
            _perform_data_whitening(SID_PAL_RADIO_FSK_WHITENING_SEED, tx_buffer + STM32WLxx_RADIO_COMM_FSK_PHY_HEADER_LENGTH,
...
{
#if SID_SDK_CONFIG_ENABLE_LINK_TYPE_2
    SID_PAL_ASSERT(fsk_phy_default_cfg.whitening_seed == seed); /* Seed is not expected to be changed in runtime and due that fact is not currently sent to the STM32WLxx side */
    return RADIO_ERROR_NONE;
#else
    (void)seed;
                                                                 ...
                                                                 uint8_t packetLen)
{
    ...
    else
    {
        ...
        time_on_air = stm32wlxx_phy_get_gfsk_time_on_air_in_ms(&fsk_pp, &fsk_mp) + STM32WLxx_RADIO_CFG_IRQ_PROCESS_GUARD_TIME_MS;
    }
...
#if SID_SDK_CONFIG_ENABLE_LINK_TYPE_2
SID_STM32_SPEED_OPTIMIZED const sid_pal_radio_fsk_phy_settings_t * radio_stm32wlxx_fsk_get_default_phy_config(void)
{
    return &fsk_phy_default_cfg;
}
#endif /* SID_SDK_CONFIG_ENABLE_LINK_TYPE_2 */
