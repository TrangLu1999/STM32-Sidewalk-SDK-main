...
#ifndef __STM32WLXX_APP_RADIO_H_
#define __STM32WLXX_APP_RADIO_H_
 ...
 * STM32WLxx device.
 *
 * @param[in] use_defaults A boolean flag (TRUE/FALSE) indicating if the default
 * settings are sent out. When set to false, the last applied settings are sent.
 ...
 */
int32_t stm32wlxx_radio_send_subghz_config(const uint32_t use_defaults, const uint32_t need_ack);
...
#if SID_SDK_CONFIG_ENABLE_LINK_TYPE_2
/**
 * @brief Returns a pointer to a default FSK PHY configuration
 * @attention This is an internal API and it may not cover some PHY parameters
 *
 * @return Pointer to the default PHY configuration
 */
const sid_pal_radio_fsk_phy_settings_t * radio_stm32wlxx_fsk_get_default_phy_config(void);
#endif /* SID_SDK_CONFIG_ENABLE_LINK_TYPE_2 */

#if SID_SDK_CONFIG_ENABLE_LINK_TYPE_3
/**
 * @brief Returns a pointer to a default LoRa PHY configuration
 * @attention This is an internal API and it may not cover some PHY parameters
 *
 * @return Pointer to the default PHY configuration
 */
const sid_pal_radio_lora_phy_settings_t * radio_stm32wlxx_lora_get_default_phy_config(void);
#endif /* SID_SDK_CONFIG_ENABLE_LINK_TYPE_3 */
...
#endif /* __STM32WLXX_APP_RADIO_H_ */
