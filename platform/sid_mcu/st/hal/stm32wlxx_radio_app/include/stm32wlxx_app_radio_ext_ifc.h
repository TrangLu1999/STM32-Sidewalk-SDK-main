/**
  ******************************************************************************
  * @file    stm32wlxx_app_radio_ext_ifc.h
...
#ifndef __STM32WLXX_APP_RADIO_EXT_IFC_H_
#define __STM32WLXX_APP_RADIO_EXT_IFC_H_
 ...
 */
typedef void (*stm32wlxx_ext_ifc_on_incoming_user_data)(const uint8_t * const data, const uint32_t data_len, void * user_arg);
 ...
 */
sid_error_t sid_pal_radio_stm32wlxx_set_user_data_received_cb(stm32wlxx_ext_ifc_on_incoming_user_data callback, void * user_arg);
...
#endif /* __STM32WLXX_APP_RADIO_EXT_IFC_H_ */
