 ...
 */
#define SID_STM32_UTIL_ROUNDUP_TO_POW_2_EXP(__x__)   ((uint32_t)(32u - __CLZ((__x__) - 1u)))

/**
 * @brief Rounds the supplied value up to the nearest power of 2
 */
#define SID_STM32_UTIL_ROUNDUP_TO_POW_2(__x__)       ((uint32_t)(1u << (ROUNDUP_NEXT_POW_2_EXP(__x__) - 1u)))

/**
 * @brief Computes exponent of the nearest power of 2 that is less or equal than the supplied value
 */
#define SID_STM32_UTIL_ROUNDDOWN_TO_POW_2_EXP(__x__) ((uint32_t)(32u - __CLZ(__x__) - 1u))

/**
 * @brief Rounds the supplied value down to the nearest power of 2
 */
#define SID_STM32_UTIL_ROUNDDOWN_TO_POW_2(__x__)     ((uint32_t)(1u << (SID_STM32_UTIL_ROUNDDOWN_PREV_POW_2_EXP(__x__) - 1u)))
...
/**
  ...
  * @warning This implementation is not compatible with hardware FIFOs and other sources and destinations that require only sequential access.
...
/**
  ...
  * @note   This implementation allows unaligned _dst and _src locations, however performance is degraded in such cases
  * @warning This implementation is not compatible with hardware FIFOs and other destinations that require only sequential access.
  * @param  _dst Pointer to the destination memory location
...
/**
  ...
  * @warning This implementation is not compatible with hardware FIFOs and other sources that require only sequential access.
