...
#ifndef SID_STM32_STRINGIFY
#  define SID_STM32_STRINGIFY(x) #x
#endif /* SID_STM32_STRINGIFY */

#ifndef SID_STM32_TOSTRING
#  define SID_STM32_TOSTRING(x) SID_STM32_STRINGIFY(x)
#endif /* SID_STM32_TOSTRING */
...
#if defined(__ICCARM__) /* IAR Compiler */
#  define SID_STM32_STACKLESS_FUNCTION __stackless
#elif defined (__ARMCC_VERSION) && (__ARMCC_VERSION >= 6010050)  /* ARM Compiler V6 */
#  define SID_STM32_STACKLESS_FUNCTION __attribute__((naked))
#elif defined(__GNUC__) /* GNU Compiler */
#  define SID_STM32_STACKLESS_FUNCTION __attribute__((naked))
#else
...
/* Macro to get variable aligned to a user-defined boundary */
#if defined(__ICCARM__) /* IAR Compiler */
#  define SID_STM32_ALIGN_AS(alignment, buf) _Pragma(SID_STM32_TOSTRING(data_alignment=alignment)) buf
#elif defined (__ARMCC_VERSION) && (__ARMCC_VERSION >= 6010050)  /* ARM Compiler V6 */
#  define SID_STM32_ALIGN_AS(alignment, buf) __ALIGNED(alignment) buf
#elif defined(__GNUC__) /* GNU Compiler */
#  define SID_STM32_ALIGN_AS(alignment, buf) buf __attribute__ ((aligned (alignment)))
#endif /* __ICCARM__ */
