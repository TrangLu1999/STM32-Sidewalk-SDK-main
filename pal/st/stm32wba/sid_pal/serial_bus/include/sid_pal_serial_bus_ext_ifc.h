...
/**
 * @brief Notify SPI driver about leaving Standby LPM.
 * @note This method restores all peripheral configurations and GPIO states associated with SPI. It shall be called as a part of Standby exit process
 */
void sid_pal_serial_bus_ext_ifc_notify_standby_exit(void);
