...
static const sid_ble_config_t sid_ble_default_cfg;
 ...
 */
const sid_ble_cfg_service_t sid_ble_ama_service = {
    /* AMA service - fe03 */
    .type = AMA_SERVICE,
    .id = {
        .type = UUID_TYPE_16,
 ...
 */
const sid_ble_cfg_characteristics_t sid_ble_ama_svc_chars[] = {
    {
 ...
 */
const sid_ble_cfg_gatt_profile_t sid_ble_default_profile[] = {
    {
        /* AMA GATT Service */
...
/**
 * @brief Default BLE configuration for the Sidewalk link
 *
 * @note This is the reference configuration that follows the recommendations from Sidewalk Protocol Specification.
 *       However, you are free to override the defaults if this is required for your specific use case. To do this,
 *       define your own sid_ble_config_t object with the desired settings in your application code and redefine the
 *       app_get_sidewalk_ble_config() to return the pointer to your custom configuration instead of this one.
 */
static const sid_ble_config_t sid_ble_default_cfg = {
    ...
    .num_profile         = SID_STM32_UTIL_ARRAY_SIZE(sid_ble_default_profile),
    .profile             = sid_ble_default_profile,
    .max_tx_power_in_dbm = SID_STM32_BLE_RADIO_MAX_TX_POWER_EU,                                 /* Use EU's +10dBm EIRP limit as a universal worldwide setting */
    .enable_link_metrics = true,
    .metrics_msg_retries = 3u,
    .inactivity_timeout  = SID_SDK_CONFIG_BLE_INACTIVITY_TIMEOUT_SEC,                           /*!< Default Sidewalk BLE inactivity timeout is 30 seconds. Users may adjust it within 1..3600 seconds range. Any out of range value will be overriden with 30 seconds */
};
