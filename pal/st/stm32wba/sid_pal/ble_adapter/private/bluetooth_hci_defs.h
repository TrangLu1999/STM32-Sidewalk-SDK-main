...
#define SID_BLE_HCI_STATUS_CONN_ACCEPT_TIMEOUT                                   (0x10u) /*!< Connection Accept Timeout Exceeded */
...
#define SID_BLE_HCI_STATUS_LINK_KEY_CHANGE_DISALLOWED                            (0x26u) /*!< Link Key cannot be Changed */
...
#define SID_BLE_HCI_LE_EVENT_MASK_CIS_ESTABLISHED_V2                             ((uint64_t)1U << 41) /*!< LE CIS Established event [v2] */
#define SID_BLE_HCI_LE_EVENT_MASK_READ_ALL_REMOTE_FEATURES_COMPLETE              ((uint64_t)1U << 42) /*!< LE Read All Remote Features Complete event */
#define SID_BLE_HCI_LE_EVENT_MASK_CS_READ_REMOTE_SUPPORTED_CAPABILITIES_COMPLETE ((uint64_t)1U << 43) /*!< LE CS Read Remote Supported Capabilities Complete event */
#define SID_BLE_HCI_LE_EVENT_MASK_CS_READ_REMOTE_FAE_TABLE_COMPLETE              ((uint64_t)1U << 44) /*!< LE CS Read Remote FAE Table Complete event */
#define SID_BLE_HCI_LE_EVENT_MASK_CS_SECURITY_ENABLE_COMPLETE                    ((uint64_t)1U << 45) /*!< LE CS Security Enable Complete event */
#define SID_BLE_HCI_LE_EVENT_MASK_CS_CONFIG_COMPLETE                             ((uint64_t)1U << 46) /*!< LE CS Config Complete event */
#define SID_BLE_HCI_LE_EVENT_MASK_CS_PROCEDURE_ENABLE_COMPLETE                   ((uint64_t)1U << 47) /*!< LE CS Procedure Enable Complete event */
#define SID_BLE_HCI_LE_EVENT_MASK_CS_SUBEVENT_RESULT                             ((uint64_t)1U << 48) /*!< LE CS Subevent Result event */
#define SID_BLE_HCI_LE_EVENT_MASK_CS_SUBEVENT_RESULT_CONTINUE                    ((uint64_t)1U << 49) /*!< LE CS Subevent Result Continue event */
#define SID_BLE_HCI_LE_EVENT_MASK_CS_TEST_END_COMPLETE                           ((uint64_t)1U << 50) /*!< LE CS Test End Complete event */
#define SID_BLE_HCI_LE_EVENT_MASK_MONITORED_ADVERTISERS_REPORT                   ((uint64_t)1U << 51) /*!< LE Monitored Advertisers Report event */
#define SID_BLE_HCI_LE_EVENT_MASK_FRAME_SPACE_UPDATE_COMPLETE                    ((uint64_t)1U << 52) /*!< LE Frame Space Update Complete event */
...
/*----------------------------------------------------------------------------*/
/* HCI Power Level Types. See Core Specification [Vol 4, Part E, 7.3.35] */
#define SID_BLE_HCI_TX_POWER_LEVEL_TYPE_CURRENT                                  (0x00u) /*!< Current Transmit Power Level */
#define SID_BLE_HCI_TX_POWER_LEVEL_TYPE_MAXIMUM                                  (0x01u) /*!< Maximum Transmit Power Level */

/* HCI LE PHY values for Power Level Types. See Core Specification [Vol 4, Part E, 7.8.117-7.8.118] */
#define SID_BLE_HCI_TX_POWER_PHY_LE_1M                                           (0x01u) /*!< LE 1M PHY */
#define SID_BLE_HCI_TX_POWER_PHY_LE_2M                                           (0x02u) /*!< LE 2M PHY */
#define SID_BLE_HCI_TX_POWER_PHY_LE_CODED_S8                                     (0x03u) /*!< LE Coded PHY with S=8 data coding */
#define SID_BLE_HCI_TX_POWER_PHY_LE_CODED_S2                                     (0x04u) /*!< LE Coded PHY with S=2 data coding */
