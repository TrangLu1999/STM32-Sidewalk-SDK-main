...
#define SID_STM32_BLE_TX_POWER_TABLE_ID_HPA                                 (0x00u) /*!, High power: RF TX output level from -20 dBm to +10 dBm */
#define SID_STM32_BLE_TX_POWER_TABLE_ID_LPA                                 (0x01u) /*!< Low power: RF TX output level from -20 dBm to +3 dBm */

#define SID_STM32_BLE_LL_POWER_VALUE_INVALID                                (126)   /*!< Special value reported by LL to indicate that requested power level is not valid (e.g., power level requested for a connection differs from the PHY configuration) */
