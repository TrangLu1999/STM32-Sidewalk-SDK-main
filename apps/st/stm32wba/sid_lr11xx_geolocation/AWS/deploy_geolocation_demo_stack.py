...
AWS_DEPLOYMENT_SCRIPT_NAME = 'deploy_geolocation_demo_stack.py'  # The name of the deployment script located in the SHARED_AWS_CODE_ROOT_DIR. Attention: this is not the name of this file
...
def main():
    try:
        ...
        # Now call the deployment script
        subprocess.run(
            [sys.executable, os.path.join(SHARED_AWS_CODE_ROOT_DIR, AWS_DEPLOYMENT_SCRIPT_NAME),
