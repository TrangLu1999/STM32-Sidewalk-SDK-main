...
#define SID_MAIN_TASK_STACK_SIZE                (1465*4)
#define SID_MAIN_TASK_PRIO                      ((osPriority_t) osPriorityNormal)

#define GEOLOCATION_DEMO_TASK_STACK_SIZE        (274*4)
#define GEOLOCATION_DEMO_TASK_PRIO              ((osPriority_t) osPriorityBelowNormal)
