...
#define UTIL_ADV_TRACE_INIT_CRITICAL_SECTION( )    UTIL_ADV_TRACE_CriticalSectionInit()                          /*!< init the critical section in trace feature */
#define UTIL_ADV_TRACE_ENTER_CRITICAL_SECTION( )   const uint32_t __adv_trace_cs_uses_mutex = \
                                                   UTIL_ADV_TRACE_EnterCriticalSection()                         /*!< enter the critical section in trace feature */
#define UTIL_ADV_TRACE_EXIT_CRITICAL_SECTION( )    UTIL_ADV_TRACE_ExitCriticalSection(__adv_trace_cs_uses_mutex) /*!< exit the critical section in trace feature */
#define UTIL_ADV_TRACE_TMP_BUF_SIZE                (CFG_LOG_TRACE_BUF_SIZE)                                      /*!< default trace buffer size */
...
#define UTIL_ADV_TRACE_MEMSET8( dest, value, size) SID_STM32_UTIL_fast_memset((dest),(value),(size))             /*!< memset utilities interface to trace feature */
...
uint32_t UTIL_ADV_TRACE_EnterCriticalSection(void);
void UTIL_ADV_TRACE_ExitCriticalSection(const uint32_t mutex_used);
