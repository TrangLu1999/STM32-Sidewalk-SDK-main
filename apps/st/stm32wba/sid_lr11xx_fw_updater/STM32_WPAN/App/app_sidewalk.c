/**
  ******************************************************************************
  * @file    app_sidewalk.c
  * @brief   Firmware update utility app for LR11xx transceivers
  ******************************************************************************
  * @attention
  *
...
static void sidewalk_stack_task_entry(void *context)
{
    ...
    SID_PAL_LOG_INFO("sid_lr11xx_fw_updater application started...");
    ...
    SID_PAL_LOG_INFO("sid_lr11xx_fw_updater application terminated");
    SID_PAL_LOG_FLUSH();
    osThreadExit();
}
