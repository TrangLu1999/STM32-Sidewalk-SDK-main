...
#  endif /* NUCLEO_WBA52_BOARD || NUCLEO_WBA55_BOARD || NUCLEO_WBA65_BOARD */
    ...
    .state_timings = {
        .sleep_to_full_power_us   = S2LP_RADIO_CFG_USE_DEFAULT_TIMINGS, /*!< Wake-up time without RCO calibration */
        .full_power_to_sleep_us   = S2LP_RADIO_CFG_UNUSED_TIMING_VALUE, /*!< Currently not used by Sidewalk SDK */
        .rx_to_tx_us              = S2LP_RADIO_CFG_UNUSED_TIMING_VALUE, /*!< Currently not used by Sidewalk SDK */
        .tx_to_rx_us              = S2LP_RADIO_CFG_UNUSED_TIMING_VALUE, /*!< Currently not used by Sidewalk SDK */
        .tcxo_delay_us            = S2LP_RADIO_CFG_UNUSED_TIMING_VALUE, /*!< Currently not used by Sidewalk SDK */
    },
