...
#  endif /* NUCLEO_WBA52_BOARD || NUCLEO_WBA55_BOARD || NUCLEO_WBA65_BOARD */
    ...
    .tcxo_config = {
        ...
        .timeout_us             = SX126X_RADIO_CFG_USE_DEFAULT_TIMINGS, /*!< TCXO start time in microseconds */
    },
    ...
    .state_timings = {
        .sleep_to_full_power_us = SX126X_RADIO_CFG_USE_DEFAULT_TIMINGS, /*!< Time to wake up the radio and reach STBY_XOSC state. IMPORTANT: this setting should not account for TCXO startup delay as this delay is added automatically by the driver */
        .full_power_to_sleep_us = SX126X_RADIO_CFG_UNUSED_TIMING_VALUE, /*!< Currently not used by Sidewalk SDK */
        .rx_to_tx_us            = SX126X_RADIO_CFG_UNUSED_TIMING_VALUE, /*!< Currently not used by Sidewalk SDK */
        .tx_to_rx_us            = SX126X_RADIO_CFG_UNUSED_TIMING_VALUE, /*!< Currently not used by Sidewalk SDK */
