...
#  error "This configuration supports only STM32WBA5x and STM32WBA6x MCU families"
    ...
    .client_selector_context = (void *)&radio_spi_transaction_config,
};
...
#  endif /* NUCLEO_WBA52_BOARD || NUCLEO_WBA55_BOARD || NUCLEO_WBA65_BOARD */
    ...
    .tcxo_config = {
        ...
        .timeout_us             = LR11XX_RADIO_CFG_USE_DEFAULT_TIMINGS,
#if LR11XX_RADIO_CFG_GEOLOCATION_SUPPORT
        .gnss_timeout_us        = LR11XX_RADIO_CFG_USE_DEFAULT_TIMINGS,
# endif /* LR11XX_RADIO_CFG_GEOLOCATION_SUPPORT */
    },
    ...
    .state_timings = {
        .sleep_to_full_power_us = LR11XX_RADIO_CFG_USE_DEFAULT_TIMINGS, /*!< Time to wake up the radio and reach STDBY_XOSC state. IMPORTANT: this setting should not account for TCXO startup delay as this delay is added automatically by the driver */
        .full_power_to_sleep_us = LR11XX_RADIO_CFG_UNUSED_TIMING_VALUE, /*!< Currently not used by Sidewalk SDK */
        .rx_to_tx_us            = LR11XX_RADIO_CFG_UNUSED_TIMING_VALUE, /*!< Currently not used by Sidewalk SDK */
        .tx_to_rx_us            = LR11XX_RADIO_CFG_UNUSED_TIMING_VALUE, /*!< Currently not used by Sidewalk SDK */
...
#  if  SID_SDK_CONFIG_ENABLE_GNSS
        .gnss = {
            .active_constellations = SMTC_MODEM_GNSS_CONSTELLATION_GPS_BEIDOU,
            .scan_mode             = SMTC_MODEM_GNSS_MODE_MOBILE,
            .retry_limit           = 5u,
            .retry_interval_s      = 60u,
        },
