...
#  endif /* SID_STM32_BLE_CFG_USE_EXTERNAL_LNA */
    ...
    .sidewalk_profile = {
        ...
        .device_name       = "sid_dut_nucleo-wba52",
#elif defined(NUCLEO_WBA55_BOARD)
        .device_name       = "sid_dut_nucleo-wba55",
#elif defined(NUCLEO_WBA65_BOARD)
        .device_name       = "sid_dut_nucleo-wba65",
#elif defined(STM32WBA5x)
        .device_name       = "sid_dut_stm32wba5x",
#elif defined(STM32WBA6x)
        .device_name       = "sid_dut_stm32wba6x",
#else
