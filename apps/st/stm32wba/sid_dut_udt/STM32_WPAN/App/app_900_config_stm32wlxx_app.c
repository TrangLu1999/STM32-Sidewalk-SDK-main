...
#  endif /* NUCLEO_WBA52_BOARD || NUCLEO_WBA55_BOARD || NUCLEO_WBA65_BOARD */
    ...
    .state_timings = {
        .sleep_to_full_power_us = STM32WLxx_RADIO_CFG_USE_DEFAULT_TIMINGS, /* Time to reach the STDBY_XOSC state */
        .full_power_to_sleep_us = STM32WLxx_RADIO_CFG_UNUSED_TIMING_VALUE, /* Currently not used by Sidewalk SDK */
        .rx_to_tx_us            = STM32WLxx_RADIO_CFG_UNUSED_TIMING_VALUE, /* Currently not used by Sidewalk SDK */
        .tx_to_rx_us            = STM32WLxx_RADIO_CFG_UNUSED_TIMING_VALUE, /* Currently not used by Sidewalk SDK */
        /* .tcxo_delay_us is automatically set to STM32WLxx_RADIO_COMM_TCXO_TIMEOUT_DURATION by the driver whenever TCXO is used */
    },
    ...
    /* User-defined compatibility checks for inter-MCU protocol and application versions */
    .protocol_compatibility_check_cb = NULL,
    .app_compatibility_check_cb      = NULL,
};
