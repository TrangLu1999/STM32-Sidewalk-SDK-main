...
/**
 * @brief  Performs initialization of the LED status indication module
...
/**
 * @brief Standby LPM pre-entry actions: backs up current LED states
 */
void led_indication_enter_standby(void);

/**
 * @brief Standby LPM post-exit actions: restore LED GPIO config and resumes operation
 */
void led_indication_exit_standby(void);
