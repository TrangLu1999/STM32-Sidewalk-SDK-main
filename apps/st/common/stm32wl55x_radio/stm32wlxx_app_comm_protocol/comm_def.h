...
#define STM32WLxx_RADIO_COMM_PROTOCOL_MINOR_VERSION      (1u)
#define STM32WLxx_RADIO_COMM_PROTOCOL_PATCH_VERSION      (0u)
...
#define STM32WLxx_RADIO_COMM_LORA_CAD_IRQ_MASK           ( STM32WLxx_RADIO_COMM_DEFAULT_LORA_IRQ_MASK \
...
#define STM32WLxx_SUBGHZ_CAD_EXIT_MODE_RX_BIT_OFFSET     (0u)
#define STM32WLxx_SUBGHZ_CAD_EXIT_MODE_LBT_BIT_OFFSET    (1u)
#define STM32WLxx_SUBGHZ_CAD_EXIT_MODE_ED_BIT_OFFSET     (2u)
#define STM32WLxx_SUBGHZ_CAD_EXIT_MODE_UNDEFINED         (0xFFu)
...
#define STM32WLxx_SUBGHZ_ZIP_CAD_EXIT_MODE(_MODE_)       ((STM32WLxx_RADIO_CAD_EXIT_MODE_CS_ONLY == (_MODE_)) ? 0u : \
                                                          (STM32WLxx_RADIO_CAD_EXIT_MODE_CS_RX   == (_MODE_)) ? ((uint8_t)(1u << STM32WLxx_SUBGHZ_CAD_EXIT_MODE_RX_BIT_OFFSET)) : \
                                                          (STM32WLxx_RADIO_CAD_EXIT_MODE_CS_LBT  == (_MODE_)) ? ((uint8_t)(1u << STM32WLxx_SUBGHZ_CAD_EXIT_MODE_LBT_BIT_OFFSET)) : \
                                                          (STM32WLxx_RADIO_CAD_EXIT_MODE_ED_ONLY == (_MODE_)) ? ((uint8_t)(1u << STM32WLxx_SUBGHZ_CAD_EXIT_MODE_ED_BIT_OFFSET)) : \
                                                          (STM32WLxx_RADIO_CAD_EXIT_MODE_ED_RX   == (_MODE_)) ? ((uint8_t)((1u << STM32WLxx_SUBGHZ_CAD_EXIT_MODE_ED_BIT_OFFSET) | (1u << STM32WLxx_SUBGHZ_CAD_EXIT_MODE_RX_BIT_OFFSET))) : \
                                                          (STM32WLxx_RADIO_CAD_EXIT_MODE_ED_LBT  == (_MODE_)) ? ((uint8_t)((1u << STM32WLxx_SUBGHZ_CAD_EXIT_MODE_ED_BIT_OFFSET) | (1u << STM32WLxx_SUBGHZ_CAD_EXIT_MODE_LBT_BIT_OFFSET))) : \
                                                          (uint8_t)STM32WLxx_SUBGHZ_CAD_EXIT_MODE_UNDEFINED)

#define STM32WLxx_SUBGHZ_UNZIP_CAD_EXIT_MODE(_MODE_)     ((0u == (_MODE_)) ? STM32WLxx_RADIO_CAD_EXIT_MODE_CS_ONLY : \
                                                          (((uint8_t)(1u << STM32WLxx_SUBGHZ_CAD_EXIT_MODE_RX_BIT_OFFSET)) == (_MODE_)) ? STM32WLxx_RADIO_CAD_EXIT_MODE_CS_RX : \
                                                          (((uint8_t)(1u << STM32WLxx_SUBGHZ_CAD_EXIT_MODE_LBT_BIT_OFFSET)) == (_MODE_)) ? STM32WLxx_RADIO_CAD_EXIT_MODE_CS_LBT : \
                                                          (((uint8_t)(1u << STM32WLxx_SUBGHZ_CAD_EXIT_MODE_ED_BIT_OFFSET)) == (_MODE_)) ? STM32WLxx_RADIO_CAD_EXIT_MODE_ED_ONLY : \
                                                          (((uint8_t)((1u << STM32WLxx_SUBGHZ_CAD_EXIT_MODE_ED_BIT_OFFSET) | (1u << STM32WLxx_SUBGHZ_CAD_EXIT_MODE_RX_BIT_OFFSET))) == (_MODE_)) ? STM32WLxx_RADIO_CAD_EXIT_MODE_ED_RX : \
                                                          (((uint8_t)((1u << STM32WLxx_SUBGHZ_CAD_EXIT_MODE_ED_BIT_OFFSET) | (1u << STM32WLxx_SUBGHZ_CAD_EXIT_MODE_LBT_BIT_OFFSET))) == (_MODE_)) ? STM32WLxx_RADIO_CAD_EXIT_MODE_ED_LBT : \
                                                          STM32WLxx_RADIO_CAD_EXIT_MODE_NONE)
...
typedef __PACKED_STRUCT {
    ...
    /**
     * @attention This CAD portion is no longer used by STM32WLxx starting from protocol version 1.1.0, but it is
     *            preserved and populated by the host MCU for backward compatibility with protocol 1.0.x. STM32WLxx
     *            driver implementing protocol version 1.1.0 and above shall not rely on the values in these fields,
     *            FSK CAD/CS parameters are now included into the Start Carrier Sense command.
     */
...
typedef __PACKED_STRUCT {
     ...
     *            preserved and populated by the host MCU for backward compatibility with protocol 1.0.x. STM32WLxx
     *            driver implementing protocol version 1.1.0 and above shall not rely on the values in these fields,
     *            LoRa CAD parameters are now distributed via a dedicated command.
     */
...
/** Radio phy configuration to be sent by host MCU to WL */
typedef __PACKED_STRUCT {
...
typedef __PACKED_UNION {
    uint8_t  bytes[8];
    uint16_t half_words[4];
    uint32_t words[2];
    uint64_t dword;
} stm32wlxx_req_completed_compact_data_t;

typedef __PACKED_STRUCT {
    uint16_t                               request_id;
    uint16_t                               status;
    stm32wlxx_req_completed_compact_data_t additional_info;
...
/**
 * @brief Payload for the Set LoRa CAD Params command
 */
typedef __PACKED_STRUCT {
    uint8_t  exit_mode;
    uint8_t  detect_peak;
    ...
    uint32_t timeout;
    uint8_t  symbol_num;
} stm32wlxx_rcp_set_lora_cad_params_req_t;
static_assert(sizeof(stm32wlxx_rcp_set_lora_cad_params_req_t) <= STM32WLxx_RADIO_COMM_FRAME_PAYLOAD_SIZE, "Size of stm32wlxx_rcp_set_lora_cad_params_req_t shall match STM32WLxx_RADIO_COMM_FRAME_PAYLOAD_SIZE");
...
/**
 * @brief Payload for the Start FSK Carrier Sense command
 */
typedef __PACKED_STRUCT {
    uint8_t  exit_mode;         /*!< Maps to stm32wlxx_pal_radio_cad_param_exit_mode_t */
    uint8_t  min_preamble_det;
    int8_t   ed_rssi_threshold;
    uint16_t ed_duration_mus;
    uint16_t lbt_preamble_len;
    uint32_t lbt_rx_timeout;
    uint32_t duration_us;
} stm32wlxx_rcp_start_fsk_cs_req_t;
static_assert(sizeof(stm32wlxx_rcp_start_fsk_cs_req_t) <= STM32WLxx_RADIO_COMM_FRAME_PAYLOAD_SIZE, "Size of stm32wlxx_rcp_start_fsk_cs_req_t shall match STM32WLxx_RADIO_COMM_FRAME_PAYLOAD_SIZE");

/** Sidewalk Phy Radio Start Rx request */
typedef __PACKED_STRUCT {
    uint32_t timeout_us;
} stm32wlxx_rcp_start_rx_req_t;
static_assert(sizeof(stm32wlxx_rcp_start_rx_req_t) <= STM32WLxx_RADIO_COMM_FRAME_PAYLOAD_SIZE, "Size of stm32wlxx_rcp_start_rx_req_t shall match STM32WLxx_RADIO_COMM_FRAME_PAYLOAD_SIZE");

/** Sidewalk Phy Radio Start Continuous Wave Tx request */
typedef __PACKED_STRUCT {
    uint32_t frequency;
} stm32wlxx_rcp_start_cw_tx_req_t;
static_assert(sizeof(stm32wlxx_rcp_start_cw_tx_req_t) <= STM32WLxx_RADIO_COMM_FRAME_PAYLOAD_SIZE, "Size of stm32wlxx_rcp_start_cw_tx_req_t shall match STM32WLxx_RADIO_COMM_FRAME_PAYLOAD_SIZE");

/** Sidewalk Phy Radio Start Infinite Preamble Tx request */
typedef __PACKED_STRUCT {
    uint32_t frequency;
} stm32wlxx_rcp_start_inf_pbl_tx_req_t;
static_assert(sizeof(stm32wlxx_rcp_start_inf_pbl_tx_req_t) <= STM32WLxx_RADIO_COMM_FRAME_PAYLOAD_SIZE, "Size of stm32wlxx_rcp_start_inf_pbl_tx_req_t shall match STM32WLxx_RADIO_COMM_FRAME_PAYLOAD_SIZE");

/** Sidewalk Phy Radio Check Channel Is Free request */
typedef __PACKED_STRUCT {
    uint32_t frequency;
    uint32_t duration_us;
    int8_t   rssi_threshold;
} stm32wlxx_rcp_is_channel_free_req_t;
static_assert(sizeof(stm32wlxx_rcp_is_channel_free_req_t) <= STM32WLxx_RADIO_COMM_FRAME_PAYLOAD_SIZE, "Size of stm32wlxx_rcp_is_channel_free_req_t shall match STM32WLxx_RADIO_COMM_FRAME_PAYLOAD_SIZE");

/** Sidewalk Phy Radio Get Channel Noise request */
typedef __PACKED_STRUCT {
    uint32_t frequency;
} stm32wlxx_rcp_get_channel_noise_req_t;
static_assert(sizeof(stm32wlxx_rcp_get_channel_noise_req_t) <= STM32WLxx_RADIO_COMM_FRAME_PAYLOAD_SIZE, "Size of stm32wlxx_rcp_get_channel_noise_req_t shall match STM32WLxx_RADIO_COMM_FRAME_PAYLOAD_SIZE");

/** Sidewalk Phy Start Rx Duty Cycle request */
typedef __PACKED_STRUCT {
    uint32_t rx_time;
    uint32_t sleep_time;
} stm32wlxx_rcp_start_rx_dc_req_t;
static_assert(sizeof(stm32wlxx_rcp_start_rx_dc_req_t) <= STM32WLxx_RADIO_COMM_FRAME_PAYLOAD_SIZE, "Size of stm32wlxx_rcp_start_rx_dc_req_t shall match STM32WLxx_RADIO_COMM_FRAME_PAYLOAD_SIZE");
...
typedef __PACKED_STRUCT {
    ...
    union {
        ...
        stm32wlxx_rcp_set_lora_cad_params_req_t   set_lora_cad_params;
        stm32wlxx_rcp_set_fsk_mod_params_req_t    set_fsk_mod_params;
        stm32wlxx_rcp_set_fsk_pkt_params_req_t    set_fsk_pkt_params;
        stm32wlxx_rcp_start_fsk_cs_req_t          start_fsk_cs_params;
        stm32wlxx_rcp_start_rx_req_t              start_rx_params;
        stm32wlxx_rcp_start_cw_tx_req_t           start_cw_tx_params;
        stm32wlxx_rcp_start_inf_pbl_tx_req_t      start_inf_pbl_tx_params;
        stm32wlxx_rcp_is_channel_free_req_t       is_channel_free_params;
        stm32wlxx_rcp_get_channel_noise_req_t     get_channel_noise_params;
        stm32wlxx_rcp_start_rx_dc_req_t           start_rx_duty_cycle_params;
    }                             payload;
