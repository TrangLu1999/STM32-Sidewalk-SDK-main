...
#define STM32WLxx_RADIO_COMM_OPCODE_START_INFINITE_PBL_TX     (0x21u) /*!< Start Infinite Preamble Tx - transmits preamble until the radio is pushed into Standby or Sleep state */
