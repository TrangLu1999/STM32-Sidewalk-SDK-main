...
#  define SID_PAL_LOG_ERROR(msg, ...)   __SID_PAL_LOG_LIKE_PRINT_FUNC("[%u]"LOG_ERROR_COLOR"["LOG_SEVERITY_NAME_ERROR"]"COLOR_RESET": "msg SID_PAL_LOG_LINE_ENDING, __SID_PAL_LOG_LIKE_TIMESTAMP_FUNC(), ##__VA_ARGS__)
#else
#  define SID_PAL_LOG_ERROR(...)        ((void)0u)
#endif

#if SID_PAL_LOG_LEVEL >= SID_PAL_LOG_SEVERITY_WARNING
#  define SID_PAL_LOG_WARNING(msg, ...) __SID_PAL_LOG_LIKE_PRINT_FUNC("[%u]"LOG_WARNING_COLOR"["LOG_SEVERITY_NAME_WARNING"]"COLOR_RESET": "msg SID_PAL_LOG_LINE_ENDING, __SID_PAL_LOG_LIKE_TIMESTAMP_FUNC(), ##__VA_ARGS__)
#else
#  define SID_PAL_LOG_WARNING(...)      ((void)0u)
#endif

#if SID_PAL_LOG_LEVEL >= SID_PAL_LOG_SEVERITY_INFO
#  define SID_PAL_LOG_INFO(msg, ...)    __SID_PAL_LOG_LIKE_PRINT_FUNC("[%u]"LOG_INFO_COLOR"["LOG_SEVERITY_NAME_INFO"]"COLOR_RESET": "msg SID_PAL_LOG_LINE_ENDING, __SID_PAL_LOG_LIKE_TIMESTAMP_FUNC(), ##__VA_ARGS__)
#else
#  define SID_PAL_LOG_INFO(...)         ((void)0u)
#endif

#if SID_PAL_LOG_LEVEL >= SID_PAL_LOG_SEVERITY_DEBUG
#  define SID_PAL_LOG_DEBUG(msg, ...)   __SID_PAL_LOG_LIKE_PRINT_FUNC("[%u]"LOG_DEBUG_COLOR"["LOG_SEVERITY_NAME_DEBUG"]"COLOR_RESET": "msg SID_PAL_LOG_LINE_ENDING, __SID_PAL_LOG_LIKE_TIMESTAMP_FUNC(), ##__VA_ARGS__)
#else
