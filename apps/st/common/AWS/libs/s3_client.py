...
class S3Client:
    ...
    def create_bucket(self, bucket_name: str, object_ownership: str|None=None):
    ...
    def put_object(self, bucket_name: str, bucket_key: str, content_type: str, file_path: str|None=None, raw_bytes: BytesIO=None):
    ...
    def is_bucket_folder_empty(self, bucket_name: str, folder_name: str) -> bool:
        if self.bucket_exists(bucket_name):
            ...
            count =  sum(1 for _ in bucket.objects.filter(Prefix=folder_name))
        else:
            count = 0
