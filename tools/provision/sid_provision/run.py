...
ARG_GROUPS = [
    SidPlatformArgs(
        ...
        chips=[
            # STM32WBA6x family
            SidChipAddr(name="WBA65xI", full_name="STM32WBA65xI", mem=0, offset_addr=0x081FE000, default=True),
            SidChipAddr(name="WBA65xG", full_name="STM32WBA65xG", offset_addr=0x080FE000),
            SidChipAddr(name="WBA64xI", full_name="STM32WBA64xI", offset_addr=0x081FE000),
            SidChipAddr(name="WBA64xG", full_name="STM32WBA64xG", offset_addr=0x080FE000),
            SidChipAddr(name="WBA63xI", full_name="STM32WBA63xI", offset_addr=0x081FE000),
            SidChipAddr(name="WBA63xG", full_name="STM32WBA63xG", offset_addr=0x080FE000),
            SidChipAddr(name="WBA62xI", full_name="STM32WBA62xI", offset_addr=0x081FE000),
            SidChipAddr(name="WBA62xG", full_name="STM32WBA62xG", offset_addr=0x080FE000),

            # STM32WBA5x family
            SidChipAddr(name="WBA5M",   full_name="STM32WBA5MMG", offset_addr=0x080FE000),
            SidChipAddr(name="WBA55xG", full_name="STM32WBA55xG", offset_addr=0x080FE000),
            SidChipAddr(name="WBA55xE", full_name="STM32WBA55xE", offset_addr=0x0807E000),
            SidChipAddr(name="WBA54xG", full_name="STM32WBA55xG", offset_addr=0x080FE000),
            SidChipAddr(name="WBA54xE", full_name="STM32WBA55xE", offset_addr=0x0807E000),
            SidChipAddr(name="WBA52xG", full_name="STM32WBA55xG", offset_addr=0x080FE000),
            SidChipAddr(name="WBA52xE", full_name="STM32WBA55xE", offset_addr=0x0807E000),
        ],
    ),
    SidPlatformArgs(
